...
function Proyectos() {
    return (
        <section className="w-full overflow-hidden flex flex-col justify-center items-center p-5">
            <h2 className="font-bold text-center text-4xl p-5">Proyectos</h2>
            {
                proyectos.map((proyecto) => (
                    <article key={proyecto.id} className="flex">
                        <img
                            className="w-80 h-60 p-5 rounded-3xl cursor-pointer" 
                            src={`/src/assets/img/proyecto-${proyecto.img}.png`} 
                        ...
                        <div className="flex justify-center flex-col items-center gap-5 text-white text-lg">
